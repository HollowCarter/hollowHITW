...
//chatGPT
//			Scoreboard scoreboard = client.getInstance().world.getScoreboard();
//			ScoreboardObjective sidebarObjective = scoreboard.getNullableObjective("sidebar");
//			if (sidebarObjective != null && sidebarObjective.getCriterion() == ScoreboardCriterion.DUMMY) {
//				Collection<ScoreboardPlayerScore> scores = scoreboard.getAllPlayerScores(sidebarObjective);
//				
//				for (ScoreboardPlayerScore score : scores) {
//					String playerNa = score.getPlayerName();
//					int playerScore = score.getScore();
//					// Do something with playerName and playerScore
...
//get map somehow, scoreboard maybe????
